...
#from helper_module import image_files_in_folder
import re
...
def train(train_dir, model_save_path=None, n_neighbors=None, knn_algo='ball_tree', verbose=False):
    ...
    for class_dir in os.listdir(train_dir):
        ...
        for img_path in folder_image(os.path.join(train_dir, class_dir)):
...
classifier = train("training_data", model_save_path="trained_knn_model.clf", n_neighbors=1)
