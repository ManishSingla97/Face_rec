...
#----->to install face-recognition models use pip  install face_recognition
...
#getting the face_recognition model from models
face_recognition_model = face_recognition_models.face_recognition_model_location()

#getting the face_encoder 
...
def face_locations(img, number_of_times_to_upsample=3, model="hog"):
...
"""
img = PIL.Image.open("grp1.jpg")
img.convert('RGB')
print(face_locations(np.array(img)))
print(face_encodings(np.array(img)))
